    ...
    $.fn.cmd = function(options) {
        ...
        function paste() {
            ...
            self.oneTime(1, function() {
                //console.log(core.getClipb());
                self.insert(core.getClipboard());
        ...
        function keydown_event(e) {
            ...
            if (enabled) {
                if (e.metaKey && e.which === 86)
                {

                    paste();
                    return false;
                }
                else if (e.metaKey && e.which === 67 )
                {
                    core.setClipboard_(getSelectedText());
                    return false;
                }

                if (e.ctrlKey && e.which === 90)
                {
                    $Terminal.echo("^Z - Terminating task...");
                    $Terminal.kill();
                    core.hideStatus();
                    pp.setStdinMode(false); //window.setTerminalStdin(false);
                }
                    ...
                    if (!string.match(/span/)) {
                        return string.replace(url_re, function(link) {
                            ...
                            return '<a target="_blank" ' +
                                ...
                                'href="#" onclick="$Utility.openLink(\'' + link + '\');">' + link + '</a>' +
                                (comma ? '.' : '');
