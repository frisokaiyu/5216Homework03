...
function formatValue(ctx, value, recurseTimes) {
  ...
  if (isObject(value) && (typeof someVar !== 'string'))
    keys.push("__proto__");
...
},{"array-map":3,"array-reduce":4,"foreach":5,"indexof":6,"isarray":7,"json3":8,"object-keys":10}],2:[function(require,module,exports){
var nodeInspect = window.Node.inspect || {};
...
nodeInspect = require('./index');

// Replace/Create the global namespace
window.Node.inspect = nodeInspect;
...
},{"./foreach":9,"./isArguments":11}],11:[function(require,module,exports){
"use strict";
