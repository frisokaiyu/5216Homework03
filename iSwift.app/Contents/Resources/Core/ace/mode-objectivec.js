    ...
    var r = e("../lib/oop"), i = e("./doc_comment_highlight_rules").DocCommentHighlightRules, s = e("./c_cpp_highlight_rules"), o = s.c_cppHighlightRules, u = function() {
        ...
        this.$rules = {
            start: [ {
                ...
                regex: "(@)(interface|protocol|property)(?!.+;)(\\s+[A-Za-z_][A-Za-z0-9_]*)(\\s*:\\s*)([A-Za-z]+)"
            }, {
                token: [ "storage.type.objc" ],
                regex: "(@end)"
            }, {
                token: [ "storage.type.objc", "entity.name.type.objc", "entity.other.inherited-class.objc" ],
                regex: "(@implementation|@interface)(\\s+[A-Za-z_][A-Za-z0-9_]*)(\\s*?::\\s*(?:[A-Za-z][A-Za-z0-9]*))?"
            }, {
                ...
                regex: "\\bNS_DURING|NS_HANDLER|NS_ENDHANDLER|weak|strong|assing|copy|retain|unsafe_unretained\\b"
            }, {
                token: [ "punctuation.definition.keyword.objc", "keyword.control.exception.objc" ],
                regex: "(@)(try|catch|finally|throw|property)\\b"
            }, {
